...
public class UserRepository2 {
	private static final Logger LOGGER = LoggerFactory.getLogger(UserRepository2.class);
...
//	}
	...
	public User findByUsername(String name) throws InterruptedException, ExecutionException {
		...
		try {
			...
			LOGGER.info("User object: {} {} {} {}", user.getId(), user.getUsername(), user.getEmail(), user.getPassword());		
			return user;
		} catch (Exception e) {
